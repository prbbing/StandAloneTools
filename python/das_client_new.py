...
def get_data(host, query, instance, idx, limit, debug, threshold=300, ckey=None,
        cert=None, das_headers=True):
    """Contact DAS server and retrieve data for given DAS query"""
    params  = {'input':query, 'instance':instance, 'idx':idx, 'limit':limit}
    path    = '/das/cache'
...
def main():
    ...
    if  opts.format == 'plain':
        jsondict = get_data(host, query, instance, idx, limit, debug, thr, ckey, cert)
